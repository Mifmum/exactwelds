...
export const services = [
  ...
  },
  {
    ...
    description: 'Sanitary, food-grade, and architectural stainless welding with back-purged processes for code-compliant results. Suitable for commercial kitchens, railings, and pipeline work.',
    bullets: [
